...
- `apps/portal/plugins/rust-telemetry-engine/src/main.rs`
### Tech Stack
...
Defect risk, Hotspot health: 9.43/10 (stable) ·
Average: 9.43/10 ·
Worst: 5.43/10 (`apps/portal/proxy.ts`)
Maintainability, Average: 9.37/10
Performance risk, Average: 9.97/10

### Critical biomarkers
- `apps/portal/lib/shift-completeness.ts` — brain method (getShiftCompleteness) — impact −0.6
- `apps/portal/lib/ai/embeddings.ts` — brain method (batchGenerateEmbeddings) — impact −0.6
- `apps/portal/lib/ai/ollama.ts` — brain method (ollamaChatStream) — impact −0.3
